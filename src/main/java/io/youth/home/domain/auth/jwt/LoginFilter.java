...
import io.youth.home.domain.auth.dto.LoginRequest;
import io.youth.home.domain.auth.dto.LoginResponse;
import io.youth.home.domain.auth.entity.Refresh;
import io.youth.home.domain.auth.entity.TokenType;
import io.youth.home.domain.auth.repository.RefreshRepository;
...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult){
        ...
        String access = jwtUtil.createJwt(email, role, JwtUtil.ACCESS_TOKEN_EXPIRE_TIME);
        String refresh = jwtUtil.createJwt(email, role, JwtUtil.REFRESH_TOKEN_EXPIRE_TIME);
